...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="<%= request.getContextPath() %>/adm/newStaff.jsp" style="padding: 10px 20px; background-color: #28a745; color: #fff; text-decoration: none; border-radius: 4px;">Add New Staff</a>
        </div>
    </div>
</body>
</html>
